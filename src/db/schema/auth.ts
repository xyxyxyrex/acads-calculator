import { pgTable, text, timestamp, integer, uuid, index, type PgTableWithColumns, type TableConfig } from "drizzle-orm/pg-core";
...
export const users = pgTable("users", {
  ...
  emailVerificationTokenIdx: index("email_verification_token_idx").on(table.emailVerificationToken),
