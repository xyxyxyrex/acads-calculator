...
export default function GWATable() {
  ...
  const getLatinHonors = (gwa: string) => {
    ...
    if (scalingSystem === "4-point") {
      ...
      if (adjustedGwa >= 1.0 && adjustedGwa <= 1.2) return "Summa Cum Laude";
      if (adjustedGwa > 1.2 && adjustedGwa <= 1.45) return "Magna Cum Laude";
      ...
      if (adjustedGwa >= 1.0 && adjustedGwa <= 1.25) return "Summa Cum Laude";
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Add your courses to calculate your General Weighted Average
                  (GWA)
                </CardDescription>
              </div>
              <Button
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: string) =>
                          setScalingSystem(value as ScalingSystem)
                        }
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="4-point">
                            4-Point Scale (0.0 - 4.0)
                          </SelectItem>
                          <SelectItem value="5-point">
                            5-Point Scale (0.0 - 5.0)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div className="space-y-2">
                      ...
                      <Select
                        value={gradeFormat}
                        onValueChange={(value: string) =>
                          setGradeFormat(value as GradeFormat)
                        }
                      >
                        <SelectTrigger className="w-full">
                          <SelectValue />
                        ...
                        <SelectContent>
                          <SelectItem value="descending">
                            Descending (1.0 = Highest)
                          </SelectItem>
                          <SelectItem value="ascending">
                            Ascending (1.0 = Lowest)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  ...
                  <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800">
                      <strong>Current Settings:</strong> {scalingSystem} scale,{" "}
                      {gradeFormat} format (Grades range from 0.0 to {maxGrade}
                      .0)
                    </p>
                  </div>
                </CardContent>
                      ...
                      <TableRow key={course.id} className="hover:bg-gray-50">
                        ...
                        <TableCell className="p-2">
                          <Input
                            ...
                            onChange={(e) =>
                              updateRow(course.id, "courseCode", e.target.value)
                            }
                        ...
                        <TableCell className="p-2">
                          <Input
                            ...
                            value={course.units}
                            onChange={(e) =>
                              updateRow(course.id, "units", e.target.value)
                            }
                        ...
                        <TableCell className="p-2">
                          <Input
                            ...
                            value={course.gpa}
                            onChange={(e) =>
                              updateRow(course.id, "gpa", e.target.value)
                            }
                            className="border-gray-300 focus:border-blue-500 text-center"
                            min="0"
                            max={maxGrade}
                ...
                <Card className="bg-blue-50 border-blue-200">
                  <CardContent className="pt-6">
                    <div className="text-center space-y-2">
                      <h3 className="text-lg font-semibold text-gray-900">
                        Your General Weighted Average (GWA)
                      </h3>
                ...
                <Card className="bg-yellow-50 border-yellow-200">
                  <CardContent className="pt-6">
                    <div className="text-center space-y-2">
                      ...
                      <div
                        className={`text-2xl font-bold ${getHonorsColor(
                          honors
                        )}`}
                      >
                        {honors}
                    ...
                    <p className="text-xs text-gray-600 text-center pt-2">
                      NOTE: Latin honor eligibility varies, check your
                      intitutional guidelines first.
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="bg-gray-50">
                <CardContent className="pt-6">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>
                      • Select your scaling system (4-point or 5-point) and
                      grade format
                    </li>
                    <li>
                      • Fill in your course code and description (optional for
                      calculation)
                    </li>
                    <li>
                      • Enter the number of units for each course (must be
                      greater than 0)
                    </li>
                    <li>
                      • Enter your grade for each course (0.0 to {maxGrade}.0
                      scale)
                    </li>
                    <li>
                      • Your GWA will be calculated automatically based on your
                      selected format
                    </li>
                    <li>
                      • Use &quot;Add Course&quot; to add more rows, or click
                      the trash icon to remove courses
                    </li>
                    <li>
                      • Latin honors are calculated based on your selected
                      scaling system
                    </li>
                  </ul>
                </CardContent>
